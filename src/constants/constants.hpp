...
inline constexpr std::string_view whisper_cli_name = "whisper-cli";
...
inline constexpr std::string_view recorder_raw_file = "rec.raw";
inline constexpr std::string_view recorder_error_file = "rec.err";
inline constexpr std::string_view state_file = "state";
inline constexpr std::string_view transcript_file = "out.txt";
...
inline constexpr std::string_view whisper_cli_bin_rel = ".local/bin/whisper-cli";
...
inline std::filesystem::path whisper_cli_bin_path(const std::filesystem::path& home)
{
  return home / std::string(whisper_cli_bin_rel);
}
...
{
  return {asryx_bin_path(home), whisper_cli_bin_path(home),
          asryx_opt_dir(home),  whisper_checkout_dir(home),
          data_dir(home),       cache_dir(home),
          config_path(home)};
}
